  ...
  employees: {
    ...
    groups: [
      ...
      { title: "Giấy tờ (nhạy cảm)", fields: [
        { key: "cccd", label: "CCCD", icon: "CreditCard", roles: ["ceo", "head", "member"], sensitive: true },
        { key: "cccdDate", label: "Ngày cấp", icon: "Calendar", roles: ["ceo", "head", "member"], sensitive: true },
        { key: "cccdPlace", label: "Nơi cấp", icon: "Building2", roles: ["ceo", "head", "member"], sensitive: true },
        { key: "mstDate", label: "Ngày cấp MST", icon: "FileDigit", roles: ["ceo", "head", "member"], sensitive: true },
      ]},
      { title: "Lương & KPI", fields: [
        { key: "kpi", label: "KPI cá nhân", icon: "TrendingUp", roles: ["ceo", "coo", "cgo", "head", "member"], get: (r) => `${r.kpi}%` },
        { key: "salary", label: "Lương (net)", icon: "Wallet", roles: ["ceo", "head", "member"], sensitive: true, get: (r) => r.comp?.net },
      ]},
    ],
  },
