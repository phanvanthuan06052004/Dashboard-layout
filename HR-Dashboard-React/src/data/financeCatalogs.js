...
const invoiceStatus = {
  ...
  safe: { tone: "green", label: "An toàn" },
  pending: { tone: "amber", label: "Chờ phát hành" },
...
const invoices = {
  ...
  headerNote: "Phần này kế toán check hóa đơn quá hạn / đến hạn xuất hóa đơn hàng tháng",
  columns: [
    { key: "id", label: "Số HĐ", type: "mono" },
    { key: "customer", label: "Khách hàng", type: "bold" },
    { key: "plannedIssue", label: "Dự kiến xuất HĐ", type: "date" },
    { key: "actualIssue", label: "Thực tế xuất HĐ", type: "date" },
    { key: "installment", label: "Lần", type: "tag" },
  ...
  fields: [
    ...
    { key: "plannedIssue", label: "Dự kiến xuất hóa đơn", type: "date" },
    { key: "actualIssue", label: "Thực tế xuất hóa đơn", type: "date" },
    { key: "installment", label: "Lần xuất", type: "select", options: ["Lần 1", "Lần 2", "Lần 3"] },
    { key: "due", label: "Hạn thanh toán", type: "date" },
  ...
  importCols: ["Số HĐ", "Khách hàng", "Dự kiến xuất HĐ", "Thực tế xuất HĐ", "Lần", "Hạn TT", "Số tiền", "Trạng thái"],
  rows: [
    { id: "INV-26-001", customer: "Công ty CP Công nghệ FPT", plannedIssue: "01/05/2026", actualIssue: "01/05/2026", installment: "Lần 1", due: "28/05/2026", amount: 320000000, tax: 8, status: "overdue", note: "" },
    { id: "INV-26-002", customer: "Tập đoàn VinGroup", plannedIssue: "12/05/2026", actualIssue: "12/05/2026", installment: "Lần 1", due: "10/06/2026", amount: 285000000, tax: 8, status: "pending", note: "" },
    { id: "INV-26-002b", customer: "Tập đoàn VinGroup", plannedIssue: "10/06/2026", actualIssue: "", installment: "Lần 2", due: "10/07/2026", amount: 285000000, tax: 8, status: "pending", note: "Đợt 2" },
    { id: "INV-26-003", customer: "Ngân hàng Techcombank", plannedIssue: "05/05/2026", actualIssue: "05/05/2026", installment: "Lần 1", due: "02/06/2026", amount: 210000000, tax: 10, status: "overdue", note: "" },
    { id: "INV-26-003b", customer: "Ngân hàng Techcombank", plannedIssue: "02/06/2026", actualIssue: "02/06/2026", installment: "Lần 2", due: "02/07/2026", amount: 210000000, tax: 10, status: "pending", note: "Đợt 2" },
    { id: "INV-26-003c", customer: "Ngân hàng Techcombank", plannedIssue: "02/07/2026", actualIssue: "", installment: "Lần 3", due: "02/08/2026", amount: 210000000, tax: 10, status: "pending", note: "Đợt 3" },
    { id: "INV-26-004", customer: "Viettel Solutions", plannedIssue: "20/05/2026", actualIssue: "20/05/2026", installment: "Lần 1", due: "18/06/2026", amount: 185000000, tax: 8, status: "safe", note: "" },
    { id: "INV-26-005", customer: "Công ty CP MoMo", plannedIssue: "18/04/2026", actualIssue: "18/04/2026", installment: "Lần 1", due: "16/05/2026", amount: 140000000, tax: 8, status: "paid", note: "Đã thu đủ" },
    { id: "INV-26-006", customer: "Shopee Việt Nam", plannedIssue: "22/05/2026", actualIssue: "22/05/2026", installment: "Lần 1", due: "20/06/2026", amount: 128000000, tax: 10, status: "pending", note: "" },
    { id: "INV-26-007", customer: "Thế Giới Di Động", plannedIssue: "01/04/2026", actualIssue: "01/04/2026", installment: "Lần 1", due: "30/04/2026", amount: 96000000, tax: 8, status: "overdue", note: "Đã nhắc 2 lần" },
    { id: "INV-26-008", customer: "Grab Việt Nam", plannedIssue: "25/05/2026", actualIssue: "25/05/2026", installment: "Lần 1", due: "12/06/2026", amount: 82000000, tax: 8, status: "paid", note: "" },
    { id: "INV-26-009", customer: "Tiki Corporation", plannedIssue: "28/05/2026", actualIssue: "", installment: "Lần 1", due: "22/06/2026", amount: 64000000, tax: 10, status: "draft", note: "Chờ duyệt" },
    { id: "INV-26-010", customer: "Tổng công ty Bưu điện VN", plannedIssue: "10/05/2026", actualIssue: "10/05/2026", installment: "Lần 1", due: "25/05/2026", amount: 162000000, tax: 8, status: "overdue", note: "" },
  ],
};
...
const arFields = [
  ...
  { key: "date", label: "Dự toán thu ngày", type: "date" },
  { key: "due", label: "Thực tế thu", type: "date" },
  { key: "installment", label: "Lần thu", type: "select", options: ["Lần 1", "Lần 2", "Lần 3"] },
  { key: "aging", label: "Tuổi nợ (ngày)", type: "number", hint: "Tự tính = ngày hiện tại − ngày hết hạn" },
  { key: "remain", label: "Còn lại (₫)", type: "number" },
  { key: "status", label: "Trạng thái", type: "status", options: debtStatus, auto: true },
];
const ar = {
  ...
  columns: [
    ...
    { key: "date", label: "Dự toán thu", type: "date" },
    { key: "due", label: "Thực tế thu", type: "date" },
    { key: "installment", label: "Lần", type: "tag" },
  ...
  fields: arFields,
  importCols: ["Khách hàng", "HĐ gốc", "Dự toán thu", "Thực tế thu", "Lần", "Còn lại", "Trạng thái"],
  rows: [
    { party: "Công ty CP Công nghệ FPT", invoice: "INV-26-001", date: "01/05/2026", due: "28/05/2026", installment: "Lần 1", aging: 45, remain: 320000000, status: "overdue" },
    { party: "Ngân hàng Techcombank", invoice: "INV-26-003", date: "05/05/2026", due: "02/06/2026", installment: "Lần 1", aging: 30, remain: 210000000, status: "overdue" },
    { party: "Tập đoàn VinGroup", invoice: "INV-26-002", date: "12/05/2026", due: "10/06/2026", installment: "Lần 1", aging: 12, remain: 285000000, status: "due" },
    { party: "Viettel Solutions", invoice: "INV-26-004", date: "20/05/2026", due: "18/06/2026", installment: "Lần 1", aging: 0, remain: 185000000, status: "current" },
    { party: "Thế Giới Di Động", invoice: "INV-26-007", date: "01/04/2026", due: "30/04/2026", installment: "Lần 1", aging: 73, remain: 96000000, status: "overdue" },
    { party: "Shopee Việt Nam", invoice: "INV-26-006", date: "22/05/2026", due: "20/06/2026", installment: "Lần 1", aging: 0, remain: 128000000, status: "current" },
    { party: "Tổng công ty Bưu điện VN", invoice: "INV-26-010", date: "10/05/2026", due: "25/05/2026", installment: "Lần 1", aging: 48, remain: 162000000, status: "overdue" },
  ],
};
const ap = {
...
const advanceStatus = {
  ...
  overdue_settlement: { tone: "red", label: "Quá hạn QT" },
  rejected: { tone: "red", label: "Từ chối" },
};
const advancesConfig = {
  ...
  columns: [
    ...
    { key: "amount", label: "Số tiền", type: "money" },
    { key: "date", label: "Ngày tạo" },
    { key: "settlementDeadline", label: "Hạn quyết toán", type: "deadline" },
    { key: "status", label: "Trạng thái", type: "badge" },
  ],
  filters: [
  ...
  fields: [
    ...
    { key: "amount", label: "Số tiền (₫)", type: "number" },
    { key: "date", label: "Ngày tạo", type: "date" },
    { key: "settlementDeadline", label: "Hạn quyết toán (+30 ngày)", type: "date", auto: true },
    { key: "settledDate", label: "Ngày quyết toán", type: "date" },
    { key: "status", label: "Trạng thái", type: "status", options: advanceStatus },
  ],
  importCols: ["Mã TU", "Dự án", "Mục đích", "Người đề xuất", "Số tiền", "Ngày tạo", "Hạn QT", "Trạng thái"],
  rows: [
    { id: "TU-001", project: "DA-2026-001", projectName: "Chuyển đổi số Bộ Công Thương", purpose: "Tạm ứng công tác Hà Nội – Workshop #2", requester: "Nguyễn Văn A", amount: 25000000, status: "settled", date: "01/04/2026", settlementDeadline: "01/05/2026", settledDate: "20/04/2026" },
    { id: "TU-002", project: "DA-2026-003", projectName: "FPT Accelerator Batch 3", purpose: "Tạm ứng chi phí sự kiện Demo Day", requester: "Hoàng Văn F", amount: 40000000, status: "approved", date: "10/06/2026", settlementDeadline: "10/07/2026", settledDate: "" },
    { id: "TU-003", project: "DA-2026-005", projectName: "BIDV CVC Advisory", purpose: "Tạm ứng đi lại & tiếp khách", requester: "Nguyễn Thị G", amount: 15000000, status: "pending", date: "19/06/2026", settlementDeadline: "19/07/2026", settledDate: "" },
    { id: "TU-004", project: "DA-2026-006", projectName: "Techstars – FinTech Platform", purpose: "Tạm ứng QA & Testing phase 1", requester: "Trần Văn H", amount: 35000000, status: "settled", date: "01/05/2026", settlementDeadline: "31/05/2026", settledDate: "25/05/2026" },
    { id: "TU-005", project: "DA-2026-002", projectName: "VinGroup Innovation Lab", purpose: "Tạm ứng mua vật liệu prototype", requester: "Phạm Thị D", amount: 20000000, status: "overdue_settlement", date: "21/05/2026", settlementDeadline: "20/06/2026", settledDate: "" },
  ],
};
