...
const META = {
  ...
  "/lookup": ["Tra cứu hồ sơ nhân sự", "Nhân sự / Tra cứu hồ sơ"],
  ...
  "/accounting/contracts": ["Theo dõi Hợp đồng", "Kế toán / Hợp đồng"],
  "/accounting/tax-archive": ["Hồ sơ thuế & BCTC", "Kế toán / Thuế & BCTC"],
  "/accounting/documents": ["Kho tài liệu kế toán", "Kế toán / Tài liệu"],
